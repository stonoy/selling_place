 ...
 *
 * @license MIT
 */var z2=e=>{throw TypeError(e)},H5=(e,t,r)=>t.has(e)||z2("Cannot "+r),Up=(e,t,r)=>(H5(e,t,"read from private field"),r?r.call(e):t.get(e)),B5=(e,t,r)=>t.has(e)?z2("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),Zw="popstate";function F5(e={}){function t(i,s){let{pathname:c,search:u,hash:f}=i.location;return Ol("",{pathname:c,search:u,hash:f},s.state&&s.state.usr||null,s.state&&s.state.key||"default")}function r(i,s){return typeof s=="string"?s:Qa(s)}return q5(t,r,null,e)}function Ie(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function qt(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function $5(){return Math.random().toString(36).substring(2,10)}function ex(e,t){return{usr:e.state,key:e.key,idx:t}}function Ol(e,t,r=null,i){return{pathname:typeof e=="string"?e:e.pathname,search:"",hash:"",...typeof t=="string"?Ja(t):t,state:r,key:t&&t.key||i||$5()}}function Qa({pathname:e="/",search:t="",hash:r=""}){return t&&t!=="?"&&(e+=t.charAt(0)==="?"?t:"?"+t),r&&r!=="#"&&(e+=r.charAt(0)==="#"?r:"#"+r),e}function Ja(e){let t={};if(e){let r=e.indexOf("#");r>=0&&(t.hash=e.substring(r),e=e.substring(0,r));let i=e.indexOf("?");i>=0&&(t.search=e.substring(i),e=e.substring(0,i)),e&&(t.pathname=e)}return t}function q5(e,t,r,i={}){let{window:s=document.defaultView,v5Compat:c=!1}=i,u=s.history,f="POP",h=null,p=y();p==null&&(p=0,u.replaceState({...u.state,idx:p},""));function y(){return(u.state||{idx:null}).idx}function v(){f="POP";let k=y(),E=k==null?null:k-p;p=k,h&&h({action:f,location:N.location,delta:E})}function w(k,E){f="PUSH";let R=Ol(N.location,k,E);p=y()+1;let O=ex(R,p),B=N.createHref(R);try{u.pushState(O,"",B)}catch(F){if(F instanceof DOMException&&F.name==="DataCloneError")throw F;s.location.assign(B)}c&&h&&h({action:f,location:N.location,delta:1})}function _(k,E){f="REPLACE";let R=Ol(N.location,k,E);p=y();let O=ex(R,p),B=N.createHref(R);u.replaceState(O,"",B),c&&h&&h({action:f,location:N.location,delta:0})}function x(k){return D2(k)}let N={get action(){return f},get location(){return e(s,u)},listen(k){if(h)throw new Error("A history only accepts one active listener");return s.addEventListener(Zw,v),h=k,()=>{s.removeEventListener(Zw,v),h=null}},createHref(k){return t(s,k)},createURL:x,encodeLocation(k){let E=x(k);return{pathname:E.pathname,search:E.search,hash:E.hash}},push:w,replace:_,go(k){return u.go(k)}};return N}function D2(e,t=!1){let r="http://localhost";typeof window<"u"&&(r=window.location.origin!=="null"?window.location.origin:window.location.href),Ie(r,"No window.location.(origin|href) available to create URL");let i=typeof e=="string"?e:Qa(e);return i=i.replace(/ $/,"%20"),!t&&i.startsWith("//")&&(i=r+i),new URL(i,r)}var sl,tx=class{constructor(e){if(B5(this,sl,new Map),e)for(let[t,r]of e)this.set(t,r)}get(e){if(Up(this,sl).has(e))return Up(this,sl).get(e);if(e.defaultValue!==void 0)return e.defaultValue;throw new Error("No value found for context")}set(e,t){Up(this,sl).set(e,t)}};sl=new WeakMap;var Y5=new Set(["lazy","caseSensitive","path","id","index","children"]);function V5(e){return Y5.has(e)}var P5=new Set(["lazy","caseSensitive","path","id","index","middleware","children"]);function I5(e){return P5.has(e)}function X5(e){return e.index===!0}function Ml(e,t,r=[],i={},s=!1){return e.map((c,u)=>{let f=[...r,String(u)],h=typeof c.id=="string"?c.id:f.join("-");if(Ie(c.index!==!0||!c.children,"Cannot specify children on an index route"),Ie(s||!i[h],`Found a route id collision on id "${h}".  Route id's must be globally unique within Data Router usages`),X5(c)){let p={...c,...t(c),id:h};return i[h]=p,p}else{let p={...c,...t(c),id:h,children:void 0};return i[h]=p,c.children&&(p.children=Ml(c.children,t,f,i,s)),p}})}function Va(e,t,r="/"){return ju(e,t,r,!1)}function ju(e,t,r,i){let s=typeof t=="string"?Ja(t):t,c=ar(s.pathname||"/",r);if(c==null)return null;let u=j2(e);W5(u);let f=null;for(let h=0;f==null&&h<u.length;++h){let p=ok(c);f=ak(u[h],p,i)}return f}function G5(e,t){let{route:r,pathname:i,params:s}=e;return{id:r.id,pathname:i,params:s,data:t[r.id],loaderData:t[r.id],handle:r.handle}}function j2(e,t=[],r=[],i="",s=!1){let c=(u,f,h=s,p)=>{let y={relativePath:p===void 0?u.path||"":p,caseSensitive:u.caseSensitive===!0,childrenIndex:f,route:u};if(y.relativePath.startsWith("/")){if(!y.relativePath.startsWith(i)&&h)return;Ie(y.relativePath.startsWith(i),`Absolute route path "${y.relativePath}" nested under path "${i}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),y.relativePath=y.relativePath.slice(i.length)}let v=jr([i,y.relativePath]),w=r.concat(y);u.children&&u.children.length>0&&(Ie(u.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${v}".`),j2(u.children,t,w,v,h)),!(u.path==null&&!u.index)&&t.push({path:v,score:nk(v,u.index),routesMeta:w})};return e.forEach((u,f)=>{if(u.path===""||!u.path?.includes("?"))c(u,f);else for(let h of L2(u.path))c(u,f,!0,h)}),t}function L2(e){let t=e.split("/");if(t.length===0)return[];let[r,...i]=t,s=r.endsWith("?"),c=r.replace(/\?$/,"");if(i.length===0)return s?[c,""]:[c];let u=L2(i.join("/")),f=[];return f.push(...u.map(h=>h===""?c:[c,h].join("/"))),s&&f.push(...u),f.map(h=>e.startsWith("/")&&h===""?"/":h)}function W5(e){e.sort((t,r)=>t.score!==r.score?r.score-t.score:rk(t.routesMeta.map(i=>i.childrenIndex),r.routesMeta.map(i=>i.childrenIndex)))}var Q5=/^:[\w-]+$/,K5=3,J5=2,Z5=1,ek=10,tk=-2,nx=e=>e==="*";function nk(e,t){let r=e.split("/"),i=r.length;return r.some(nx)&&(i+=tk),t&&(i+=J5),r.filter(s=>!nx(s)).reduce((s,c)=>s+(Q5.test(c)?K5:c===""?Z5:ek),i)}function rk(e,t){return e.length===t.length&&e.slice(0,-1).every((i,s)=>i===t[s])?e[e.length-1]-t[t.length-1]:0}function ak(e,t,r=!1){let{routesMeta:i}=e,s={},c="/",u=[];for(let f=0;f<i.length;++f){let h=i[f],p=f===i.length-1,y=c==="/"?t:t.slice(c.length)||"/",v=vd({path:h.relativePath,caseSensitive:h.caseSensitive,end:p},y),w=h.route;if(!v&&p&&r&&!i[i.length-1].route.index&&(v=vd({path:h.relativePath,caseSensitive:h.caseSensitive,end:!1},y)),!v)return null;Object.assign(s,v.params),u.push({params:s,pathname:jr([c,v.pathname]),pathnameBase:uk(jr([c,v.pathnameBase])),route:w}),v.pathnameBase!=="/"&&(c=jr([c,v.pathnameBase]))}return u}function vd(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[r,i]=ik(e.path,e.caseSensitive,e.end),s=t.match(r);if(!s)return null;let c=s[0],u=c.replace(/(.)\/+$/,"$1"),f=s.slice(1);return{params:i.reduce((p,{paramName:y,isOptional:v},w)=>{if(y==="*"){let x=f[w]||"";u=c.slice(0,c.length-x.length).replace(/(.)\/+$/,"$1")}const _=f[w];return v&&!_?p[y]=void 0:p[y]=(_||"").replace(/%2F/g,"/"),p},{}),pathname:c,pathnameBase:u,pattern:e}}function ik(e,t=!1,r=!0){qt(e==="*"||!e.endsWith("*")||e.endsWith("/*"),`Route path "${e}" will be treated as if it were "${e.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${e.replace(/\*$/,"/*")}".`);let i=[],s="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(u,f,h)=>(i.push({paramName:f,isOptional:h!=null}),h?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return e.endsWith("*")?(i.push({paramName:"*"}),s+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):r?s+="\\/*$":e!==""&&e!=="/"&&(s+="(?:(?=\\/|$))"),[new RegExp(s,t?void 0:"i"),i]}function ok(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return qt(!1,`The URL path "${e}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),e}}function ar(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let r=t.endsWith("/")?t.length-1:t.length,i=e.charAt(r);return i&&i!=="/"?null:e.slice(r)||"/"}function sk({basename:e,pathname:t}){return t==="/"?e:jr([e,t])}function lk(e,t="/"){let{pathname:r,search:i="",hash:s=""}=typeof e=="string"?Ja(e):e;return{pathname:r?r.startsWith("/")?r:ck(r,t):t,search:dk(i),hash:fk(s)}}function ck(e,t){let r=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(s=>{s===".."?r.length>1&&r.pop():s!=="."&&r.push(s)}),r.length>1?r.join("/"):"/"}function Hp(e,t,r,i){return`Cannot include a '${e}' character in a manually specified \`to.${t}\` field [${JSON.stringify(i)}].  Please separate it out to the \`to.${r}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function U2(e){return e.filter((t,r)=>r===0||t.route.path&&t.route.path.length>0)}function Sg(e){let t=U2(e);return t.map((r,i)=>i===t.length-1?r.pathname:r.pathnameBase)}function Eg(e,t,r,i=!1){let s;typeof e=="string"?s=Ja(e):(s={...e},Ie(!s.pathname||!s.pathname.includes("?"),Hp("?","pathname","search",s)),Ie(!s.pathname||!s.pathname.includes("#"),Hp("#","pathname","hash",s)),Ie(!s.search||!s.search.includes("#"),Hp("#","search","hash",s)));let c=e===""||s.pathname==="",u=c?"/":s.pathname,f;if(u==null)f=r;else{let v=t.length-1;if(!i&&u.startsWith("..")){let w=u.split("/");for(;w[0]==="..";)w.shift(),v-=1;s.pathname=w.join("/")}f=v>=0?t[v]:"/"}let h=lk(s,f),p=u&&u!=="/"&&u.endsWith("/"),y=(c||u===".")&&r.endsWith("/");return!h.pathname.endsWith("/")&&(p||y)&&(h.pathname+="/"),h}var jr=e=>e.join("/").replace(/\/\/+/g,"/"),uk=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),dk=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,fk=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e,yd=class{constructor(e,t,r,i=!1){this.status=e,this.statusText=t||"",this.internal=i,r instanceof Error?(this.data=r.toString(),this.error=r):this.data=r}};function zl(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}var H2=["POST","PUT","PATCH","DELETE"],hk=new Set(H2),pk=["GET",...H2],mk=new Set(pk),gk=new Set([301,302,303,307,308]),vk=new Set([307,308]),Bp={state:"idle",location:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},yk={state:"idle",data:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},el={state:"unblocked",proceed:void 0,reset:void 0,location:void 0},bk=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Tg=e=>bk.test(e),wk=e=>({hasErrorBoundary:!!e.hasErrorBoundary}),B2="remix-router-transitions",F2=Symbol("ResetLoaderData");function xk(e){const t=e.window?e.window:typeof window<"u"?window:void 0,r=typeof t<"u"&&typeof t.document<"u"&&typeof t.document.createElement<"u";Ie(e.routes.length>0,"You must provide a non-empty routes array to createRouter");let i=e.hydrationRouteProperties||[],s=e.mapRouteProperties||wk,c={},u=Ml(e.routes,s,void 0,c),f,h=e.basename||"/";h.startsWith("/")||(h=`/${h}`);let p=e.dataStrategy||Ck,y={...e.future},v=null,w=new Set,_=null,x=null,N=null,k=e.hydrationData!=null,E=Va(u,e.history.location,h),R=!1,O=null,B;if(E==null&&!e.patchRoutesOnNavigation){let j=tr(404,{pathname:e.history.location.pathname}),{matches:V,route:Q}=bu(u);B=!0,E=V,O={[Q.id]:j}}else if(E&&!e.hydrationData&&Sr(E,u,e.history.location.pathname).active&&(E=null),E)if(E.some(j=>j.route.lazy))B=!1;else if(!E.some(j=>Cg(j.route)))B=!0;else{let j=e.hydrationData?e.hydrationData.loaderData:null,V=e.hydrationData?e.hydrationData.errors:null;if(V){let Q=E.findIndex(se=>V[se.route.id]!==void 0);B=E.slice(0,Q+1).every(se=>!km(se.route,j,V))}else B=E.every(Q=>!km(Q.route,j,V))}else{B=!1,E=[];let j=Sr(null,u,e.history.location.pathname);j.active&&j.matches&&(R=!0,E=j.matches)}let F,M={historyAction:e.history.action,location:e.history.location,matches:E,initialized:B,navigation:Bp,restoreScrollPosition:e.hydrationData!=null?!1:null,preventScrollReset:!1,revalidation:"idle",loaderData:e.hydrationData&&e.hydrationData.loaderData||{},actionData:e.hydrationData&&e.hydrationData.actionData||null,errors:e.hydrationData&&e.hydrationData.errors||O,fetchers:new Map,blockers:new Map},G="POP",ie=!1,oe,fe=!1,he=new Map,ue=null,_e=!1,we=!1,Oe=new Set,S=new Map,z=0,H=-1,Z=new Map,re=new Set,A=new Map,Y=new Map,J=new Set,ae=new Map,le,me=null;function Re(){if(v=e.history.listen(({action:j,location:V,delta:Q})=>{if(le){le(),le=void 0;return}qt(ae.size===0||Q!=null,"You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");let se=Jl({currentLocation:M.location,nextLocation:V,historyAction:j});if(se&&Q!=null){let ce=new Promise(Se=>{le=Se});e.history.go(Q*-1),Xi(se,{state:"blocked",location:V,proceed(){Xi(se,{state:"proceeding",proceed:void 0,reset:void 0,location:V}),ce.then(()=>e.history.go(Q))},reset(){let Se=new Map(M.blockers);Se.set(se,el),Xe({blockers:Se})}});return}return It(j,V)}),r){$k(t,he);let j=()=>qk(t,he);t.addEventListener("pagehide",j),ue=()=>t.removeEventListener("pagehide",j)}return M.initialized||It("POP",M.location,{initialHydration:!0}),F}function Qe(){v&&v(),ue&&ue(),w.clear(),oe&&oe.abort(),M.fetchers.forEach((j,V)=>Ii(V)),M.blockers.forEach((j,V)=>Kl(V))}function De(j){return w.add(j),()=>w.delete(j)}function Xe(j,V={}){j.matches&&(j.matches=j.matches.map(ce=>{let Se=c[ce.route.id],Ee=ce.route;return Ee.element!==Se.element||Ee.errorElement!==Se.errorElement||Ee.hydrateFallbackElement!==Se.hydrateFallbackElement?{...ce,route:Se}:ce})),M={...M,...j};let Q=[],se=[];M.fetchers.forEach((ce,Se)=>{ce.state==="idle"&&(J.has(Se)?Q.push(Se):se.push(Se))}),J.forEach(ce=>{!M.fetchers.has(ce)&&!S.has(ce)&&Q.push(ce)}),[...w].forEach(ce=>ce(M,{deletedFetchers:Q,viewTransitionOpts:V.viewTransitionOpts,flushSync:V.flushSync===!0})),Q.forEach(ce=>Ii(ce)),se.forEach(ce=>M.fetchers.delete(ce))}function on(j,V,{flushSync:Q}={}){let se=M.actionData!=null&&M.navigation.formMethod!=null&&Cn(M.navigation.formMethod)&&M.navigation.state==="loading"&&j.state?._isRedirect!==!0,ce;V.actionData?Object.keys(V.actionData).length>0?ce=V.actionData:ce=null:se?ce=M.actionData:ce=null;let Se=V.loaderData?fx(M.loaderData,V.loaderData,V.matches||[],V.errors):M.loaderData,Ee=M.blockers;Ee.size>0&&(Ee=new Map(Ee),Ee.forEach((de,pe)=>Ee.set(pe,el)));let be=_e?!1:ni(j,V.matches||M.matches),Te=ie===!0||M.navigation.formMethod!=null&&Cn(M.navigation.formMethod)&&j.state?._isRedirect!==!0;f&&(u=f,f=void 0),_e||G==="POP"||(G==="PUSH"?e.history.push(j,j.state):G==="REPLACE"&&e.history.replace(j,j.state));let Ce;if(G==="POP"){let de=he.get(M.location.pathname);de&&de.has(j.pathname)?Ce={currentLocation:M.location,nextLocation:j}:he.has(j.pathname)&&(Ce={currentLocation:j,nextLocation:M.location})}else if(fe){let de=he.get(M.location.pathname);de?de.add(j.pathname):(de=new Set([j.pathname]),he.set(M.location.pathname,de)),Ce={currentLocation:M.location,nextLocation:j}}Xe({...V,actionData:ce,loaderData:Se,historyAction:G,location:j,initialized:!0,navigation:Bp,revalidation:"idle",restoreScrollPosition:be,preventScrollReset:Te,blockers:Ee},{viewTransitionOpts:Ce,flushSync:Q===!0}),G="POP",ie=!1,fe=!1,_e=!1,we=!1,me?.resolve(),me=null}async function ir(j,V){if(typeof j=="number"){e.history.go(j);return}let Q=Nm(M.location,M.matches,h,j,V?.fromRouteId,V?.relative),{path:se,submission:ce,error:Se}=rx(!1,Q,V),Ee=M.location,be=Ol(M.location,se,V&&V.state);be={...be,...e.history.encodeLocation(be)};let Te=V&&V.replace!=null?V.replace:void 0,Ce="PUSH";Te===!0?Ce="REPLACE":Te===!1||ce!=null&&Cn(ce.formMethod)&&ce.formAction===M.location.pathname+M.location.search&&(Ce="REPLACE");let de=V&&"preventScrollReset"in V?V.preventScrollReset===!0:void 0,pe=(V&&V.flushSync)===!0,$e=Jl({currentLocation:Ee,nextLocation:be,historyAction:Ce});if($e){Xi($e,{state:"blocked",location:be,proceed(){Xi($e,{state:"proceeding",proceed:void 0,reset:void 0,location:be}),ir(j,V)},reset(){let lt=new Map(M.blockers);lt.set($e,el),Xe({blockers:lt})}});return}await It(Ce,be,{submission:ce,pendingError:Se,preventScrollReset:de,replace:V&&V.replace,enableViewTransition:V&&V.viewTransition,flushSync:pe})}function Fr(){me||(me=Yk()),is(),Xe({revalidation:"loading"});let j=me.promise;return M.navigation.state==="submitting"?j:M.navigation.state==="idle"?(It(M.historyAction,M.location,{startUninterruptedRevalidation:!0}),j):(It(G||M.historyAction,M.navigation.location,{overrideNavigation:M.navigation,enableViewTransition:fe===!0}),j)}async function It(j,V,Q){oe&&oe.abort(),oe=null,G=j,_e=(Q&&Q.startUninterruptedRevalidation)===!0,qr(M.location,M.matches),ie=(Q&&Q.preventScrollReset)===!0,fe=(Q&&Q.enableViewTransition)===!0;let se=f||u,ce=Q&&Q.overrideNavigation,Se=Q?.initialHydration&&M.matches&&M.matches.length>0&&!R?M.matches:Va(se,V,h),Ee=(Q&&Q.flushSync)===!0;if(Se&&M.initialized&&!we&&Dk(M.location,V)&&!(Q&&Q.submission&&Cn(Q.submission.formMethod))){on(V,{matches:Se},{flushSync:Ee});return}let be=Sr(Se,se,V.pathname);if(be.active&&be.matches&&(Se=be.matches),!Se){let{error:Jt,notFoundMatches:pt,route:rt}=va(V.pathname);on(V,{matches:pt,loaderData:{},errors:{[rt.id]:Jt}},{flushSync:Ee});return}oe=new AbortController;let Te=jo(e.history,V,oe.signal,Q&&Q.submission),Ce=e.getContext?await e.getContext():new tx,de;if(Q&&Q.pendingError)de=[Pa(Se).route.id,{type:"error",error:Q.pendingError}];else if(Q&&Q.submission&&Cn(Q.submission.formMethod)){let Jt=await es(Te,V,Q.submission,Se,Ce,be.active,Q&&Q.initialHydration===!0,{replace:Q.replace,flushSync:Ee});if(Jt.shortCircuited)return;if(Jt.pendingActionResult){let[pt,rt]=Jt.pendingActionResult;if(Un(rt)&&zl(rt.error)&&rt.error.status===404){oe=null,on(V,{matches:Jt.matches,loaderData:{},errors:{[pt]:rt.error}});return}}Se=Jt.matches||Se,de=Jt.pendingActionResult,ce=Fp(V,Q.submission),Ee=!1,be.active=!1,Te=jo(e.history,Te.url,Te.signal)}let{shortCircuited:pe,matches:$e,loaderData:lt,errors:Dt}=await ts(Te,V,Se,Ce,be.active,ce,Q&&Q.submission,Q&&Q.fetcherSubmission,Q&&Q.replace,Q&&Q.initialHydration===!0,Ee,de);pe||(oe=null,on(V,{matches:$e||Se,...hx(de),loaderData:lt,errors:Dt}))}async function es(j,V,Q,se,ce,Se,Ee,be={}){is();let Te=Bk(V,Q);if(Xe({navigation:Te},{flushSync:be.flushSync===!0}),Se){let pe=await Wi(se,V.pathname,j.signal);if(pe.type==="aborted")return{shortCircuited:!0};if(pe.type==="error"){if(pe.partialMatches.length===0){let{matches:lt,route:Dt}=bu(u);return{matches:lt,pendingActionResult:[Dt.id,{type:"error",error:pe.error}]}}let $e=Pa(pe.partialMatches).route.id;return{matches:pe.partialMatches,pendingActionResult:[$e,{type:"error",error:pe.error}]}}else if(pe.matches)se=pe.matches;else{let{notFoundMatches:$e,error:lt,route:Dt}=va(V.pathname);return{matches:$e,pendingActionResult:[Dt.id,{type:"error",error:lt}]}}}let Ce,de=Lu(se,V);if(!de.route.action&&!de.route.lazy)Ce={type:"error",error:tr(405,{method:j.method,pathname:V.pathname,routeId:de.route.id})};else{let pe=qo(s,c,j,se,de,Ee?[]:i,ce),$e=await Za(j,pe,ce,null);if(Ce=$e[de.route.id],!Ce){for(let lt of se)if($e[lt.route.id]){Ce=$e[lt.route.id];break}}if(j.signal.aborted)return{shortCircuited:!0}}if(Ai(Ce)){let pe;return be&&be.replace!=null?pe=be.replace:pe=cx(Ce.response.headers.get("Location"),new URL(j.url),h)===M.location.pathname+M.location.search,await $r(j,Ce,!0,{submission:Q,replace:pe}),{shortCircuited:!0}}if(Un(Ce)){let pe=Pa(se,de.route.id);return(be&&be.replace)!==!0&&(G="PUSH"),{matches:se,pendingActionResult:[pe.route.id,Ce,de.route.id]}}return{matches:se,pendingActionResult:[de.route.id,Ce]}}async function ts(j,V,Q,se,ce,Se,Ee,be,Te,Ce,de,pe){let $e=Se||Fp(V,Ee),lt=Ee||be||mx($e),Dt=!_e&&!Ce;if(ce){if(Dt){let Xt=Wl(pe);Xe({navigation:$e,...Xt!==void 0?{actionData:Xt}:{}},{flushSync:de})}let qe=await Wi(Q,V.pathname,j.signal);if(qe.type==="aborted")return{shortCircuited:!0};if(qe.type==="error"){if(qe.partialMatches.length===0){let{matches:Yr,route:Cr}=bu(u);return{matches:Yr,loaderData:{},errors:{[Cr.id]:qe.error}}}let Xt=Pa(qe.partialMatches).route.id;return{matches:qe.partialMatches,loaderData:{},errors:{[Xt]:qe.error}}}else if(qe.matches)Q=qe.matches;else{let{error:Xt,notFoundMatches:Yr,route:Cr}=va(V.pathname);return{matches:Yr,loaderData:{},errors:{[Cr.id]:Xt}}}}let Jt=f||u,{dsMatches:pt,revalidatingFetchers:rt}=ax(j,se,s,c,e.history,M,Q,lt,V,Ce?[]:i,Ce===!0,we,Oe,J,A,re,Jt,h,e.patchRoutesOnNavigation!=null,pe);if(H=++z,!e.dataStrategy&&!pt.some(qe=>qe.shouldLoad)&&!pt.some(qe=>qe.route.middleware&&qe.route.middleware.length>0)&&rt.length===0){let qe=ln();return on(V,{matches:Q,loaderData:{},errors:pe&&Un(pe[1])?{[pe[0]]:pe[1].error}:null,...hx(pe),...qe?{fetchers:new Map(M.fetchers)}:{}},{flushSync:de}),{shortCircuited:!0}}if(Dt){let qe={};if(!ce){qe.navigation=$e;let Xt=Wl(pe);Xt!==void 0&&(qe.actionData=Xt)}rt.length>0&&(qe.fetchers=Ql(rt)),Xe(qe,{flushSync:de})}rt.forEach(qe=>{or(qe.key),qe.controller&&S.set(qe.key,qe.controller)});let lr=()=>rt.forEach(qe=>or(qe.key));oe&&oe.signal.addEventListener("abort",lr);let{loaderResults:qn,fetcherResults:pn}=await sn(pt,rt,j,se);if(j.signal.aborted)return{shortCircuited:!0};oe&&oe.signal.removeEventListener("abort",lr),rt.forEach(qe=>S.delete(qe.key));let cn=wu(qn);if(cn)return await $r(j,cn.result,!0,{replace:Te}),{shortCircuited:!0};if(cn=wu(pn),cn)return re.add(cn.key),await $r(j,cn.result,!0,{replace:Te}),{shortCircuited:!0};let{loaderData:Er,errors:bt}=dx(M,Q,qn,pe,rt,pn);Ce&&M.errors&&(bt={...M.errors,...bt});let Tr=ln(),ri=sr(H),Yn=Tr||ri||rt.length>0;return{matches:Q,loaderData:Er,errors:bt,...Yn?{fetchers:new Map(M.fetchers)}:{}}}function Wl(j){if(j&&!Un(j[1]))return{[j[0]]:j[1].data};if(M.actionData)return Object.keys(M.actionData).length===0?null:M.actionData}function Ql(j){return j.forEach(V=>{let Q=M.fetchers.get(V.key),se=tl(void 0,Q?Q.data:void 0);M.fetchers.set(V.key,se)}),new Map(M.fetchers)}async function ns(j,V,Q,se){or(j);let ce=(se&&se.flushSync)===!0,Se=f||u,Ee=Nm(M.location,M.matches,h,Q,V,se?.relative),be=Va(Se,Ee,h),Te=Sr(be,Se,Ee);if(Te.active&&Te.matches&&(be=Te.matches),!be){$n(j,V,tr(404,{pathname:Ee}),{flushSync:ce});return}let{path:Ce,submission:de,error:pe}=rx(!0,Ee,se);if(pe){$n(j,V,pe,{flushSync:ce});return}let $e=e.getContext?await e.getContext():new tx,lt=(se&&se.preventScrollReset)===!0;if(de&&Cn(de.formMethod)){await rs(j,V,Ce,be,$e,Te.active,ce,lt,de);return}A.set(j,{routeId:V,path:Ce}),await as(j,V,Ce,be,$e,Te.active,ce,lt,de)}async function rs(j,V,Q,se,ce,Se,Ee,be,Te){is(),A.delete(j);let Ce=M.fetchers.get(j);Fn(j,Fk(Te,Ce),{flushSync:Ee});let de=new AbortController,pe=jo(e.history,Q,de.signal,Te);if(Se){let Nt=await Wi(se,new URL(pe.url).pathname,pe.signal,j);if(Nt.type==="aborted")return;if(Nt.type==="error"){$n(j,V,Nt.error,{flushSync:Ee});return}else if(Nt.matches)se=Nt.matches;else{$n(j,V,tr(404,{pathname:Q}),{flushSync:Ee});return}}let $e=Lu(se,Q);if(!$e.route.action&&!$e.route.lazy){let Nt=tr(405,{method:Te.formMethod,pathname:Q,routeId:V});$n(j,V,Nt,{flushSync:Ee});return}S.set(j,de);let lt=z,Dt=qo(s,c,pe,se,$e,i,ce),pt=(await Za(pe,Dt,ce,j))[$e.route.id];if(pe.signal.aborted){S.get(j)===de&&S.delete(j);return}if(J.has(j)){if(Ai(pt)||Un(pt)){Fn(j,ca(void 0));return}}else{if(Ai(pt))if(S.delete(j),H>lt){Fn(j,ca(void 0));return}else return re.add(j),Fn(j,tl(Te)),$r(pe,pt,!1,{fetcherSubmission:Te,preventScrollReset:be});if(Un(pt)){$n(j,V,pt.error);return}}let rt=M.navigation.location||M.location,lr=jo(e.history,rt,de.signal),qn=f||u,pn=M.navigation.state!=="idle"?Va(qn,M.navigation.location,h):M.matches;Ie(pn,"Didn't find any matches after fetcher action");let cn=++z;Z.set(j,cn);let Er=tl(Te,pt.data);M.fetchers.set(j,Er);let{dsMatches:bt,revalidatingFetchers:Tr}=ax(lr,ce,s,c,e.history,M,pn,Te,rt,i,!1,we,Oe,J,A,re,qn,h,e.patchRoutesOnNavigation!=null,[$e.route.id,pt]);Tr.filter(Nt=>Nt.key!==j).forEach(Nt=>{let Vr=Nt.key,ai=M.fetchers.get(Vr),cr=tl(void 0,ai?ai.data:void 0);M.fetchers.set(Vr,cr),or(Vr),Nt.controller&&S.set(Vr,Nt.controller)}),Xe({fetchers:new Map(M.fetchers)});let ri=()=>Tr.forEach(Nt=>or(Nt.key));de.signal.addEventListener("abort",ri);let{loaderResults:Yn,fetcherResults:qe}=await sn(bt,Tr,lr,ce);if(de.signal.aborted)return;if(de.signal.removeEventListener("abort",ri),Z.delete(j),S.delete(j),Tr.forEach(Nt=>S.delete(Nt.key)),M.fetchers.has(j)){let Nt=ca(pt.data);M.fetchers.set(j,Nt)}let Xt=wu(Yn);if(Xt)return $r(lr,Xt.result,!1,{preventScrollReset:be});if(Xt=wu(qe),Xt)return re.add(Xt.key),$r(lr,Xt.result,!1,{preventScrollReset:be});let{loaderData:Yr,errors:Cr}=dx(M,pn,Yn,void 0,Tr,qe);sr(cn),M.navigation.state==="loading"&&cn>H?(Ie(G,"Expected pending action"),oe&&oe.abort(),on(M.navigation.location,{matches:pn,loaderData:Yr,errors:Cr,fetchers:new Map(M.fetchers)})):(Xe({errors:Cr,loaderData:fx(M.loaderData,Yr,pn,Cr),fetchers:new Map(M.fetchers)}),we=!1)}async function as(j,V,Q,se,ce,Se,Ee,be,Te){let Ce=M.fetchers.get(j);Fn(j,tl(Te,Ce?Ce.data:void 0),{flushSync:Ee});let de=new AbortController,pe=jo(e.history,Q,de.signal);if(Se){let rt=await Wi(se,new URL(pe.url).pathname,pe.signal,j);if(rt.type==="aborted")return;if(rt.type==="error"){$n(j,V,rt.error,{flushSync:Ee});return}else if(rt.matches)se=rt.matches;else{$n(j,V,tr(404,{pathname:Q}),{flushSync:Ee});return}}let $e=Lu(se,Q);S.set(j,de);let lt=z,Dt=qo(s,c,pe,se,$e,i,ce),pt=(await Za(pe,Dt,ce,j))[$e.route.id];if(S.get(j)===de&&S.delete(j),!pe.signal.aborted){if(J.has(j)){Fn(j,ca(void 0));return}if(Ai(pt))if(H>lt){Fn(j,ca(void 0));return}else{re.add(j),await $r(pe,pt,!1,{preventScrollReset:be});return}if(Un(pt)){$n(j,V,pt.error);return}Fn(j,ca(pt.data))}}async function $r(j,V,Q,{submission:se,fetcherSubmission:ce,preventScrollReset:Se,replace:Ee}={}){V.response.headers.has("X-Remix-Revalidate")&&(we=!0);let be=V.response.headers.get("Location");Ie(be,"Expected a Location header on the redirect Response"),be=cx(be,new URL(j.url),h);let Te=Ol(M.location,be,{_isRedirect:!0});if(r){let Dt=!1;if(V.response.headers.has("X-Remix-Reload-Document"))Dt=!0;else if(Tg(be)){const Jt=D2(be,!0);Dt=Jt.origin!==t.location.origin||ar(Jt.pathname,h)==null}if(Dt){Ee?t.location.replace(be):t.location.assign(be);return}}oe=null;let Ce=Ee===!0||V.response.headers.has("X-Remix-Replace")?"REPLACE":"PUSH",{formMethod:de,formAction:pe,formEncType:$e}=M.navigation;!se&&!ce&&de&&pe&&$e&&(se=mx(M.navigation));let lt=se||ce;if(vk.has(V.response.status)&&lt&&Cn(lt.formMethod))await It(Ce,Te,{submission:{...lt,formAction:be},preventScrollReset:Se||ie,enableViewTransition:Q?fe:void 0});else{let Dt=Fp(Te,se);await It(Ce,Te,{overrideNavigation:Dt,fetcherSubmission:ce,preventScrollReset:Se||ie,enableViewTransition:Q?fe:void 0})}}async function Za(j,V,Q,se){let ce,Se={};try{ce=await kk(p,j,V,se,Q,!1)}catch(Ee){return V.filter(be=>be.shouldLoad).forEach(be=>{Se[be.route.id]={type:"error",error:Ee}}),Se}if(j.signal.aborted)return Se;for(let[Ee,be]of Object.entries(ce))if(Uk(be)){let Te=be.result;Se[Ee]={type:"redirect",response:Mk(Te,j,Ee,V,h)}}else Se[Ee]=await Ok(be);return Se}async function sn(j,V,Q,se){let ce=Za(Q,j,se,null),Se=Promise.all(V.map(async Te=>{if(Te.matches&&Te.match&&Te.request&&Te.controller){let de=(await Za(Te.request,Te.matches,se,Te.key))[Te.match.route.id];return{[Te.key]:de}}else return Promise.resolve({[Te.key]:{type:"error",error:tr(404,{pathname:Te.path})}})})),Ee=await ce,be=(await Se).reduce((Te,Ce)=>Object.assign(Te,Ce),{});return{loaderResults:Ee,fetcherResults:be}}function is(){we=!0,A.forEach((j,V)=>{S.has(V)&&Oe.add(V),or(V)})}function Fn(j,V,Q={}){M.fetchers.set(j,V),Xe({fetchers:new Map(M.fetchers)},{flushSync:(Q&&Q.flushSync)===!0})}function $n(j,V,Q,se={}){let ce=Pa(M.matches,V);Ii(j),Xe({errors:{[ce.route.id]:Q},fetchers:new Map(M.fetchers)},{flushSync:(se&&se.flushSync)===!0})}function ei(j){return Y.set(j,(Y.get(j)||0)+1),J.has(j)&&J.delete(j),M.fetchers.get(j)||yk}function Zd(j,V){or(j,V?.reason),Fn(j,ca(null))}function Ii(j){let V=M.fetchers.get(j);S.has(j)&&!(V&&V.state==="loading"&&Z.has(j))&&or(j),A.delete(j),Z.delete(j),re.delete(j),J.delete(j),Oe.delete(j),M.fetchers.delete(j)}function ef(j){let V=(Y.get(j)||0)-1;V<=0?(Y.delete(j),J.add(j)):Y.set(j,V),Xe({fetchers:new Map(M.fetchers)})}function or(j,V){let Q=S.get(j);Q&&(Q.abort(V),S.delete(j))}function ga(j){for(let V of j){let Q=ei(V),se=ca(Q.data);M.fetchers.set(V,se)}}function ln(){let j=[],V=!1;for(let Q of re){let se=M.fetchers.get(Q);Ie(se,`Expected fetcher: ${Q}`),se.state==="loading"&&(re.delete(Q),j.push(Q),V=!0)}return ga(j),V}function sr(j){let V=[];for(let[Q,se]of Z)if(se<j){let ce=M.fetchers.get(Q);Ie(ce,`Expected fetcher: ${Q}`),ce.state==="loading"&&(or(Q),Z.delete(Q),V.push(Q))}return ga(V),V.length>0}function hn(j,V){let Q=M.blockers.get(j)||el;return ae.get(j)!==V&&ae.set(j,V),Q}function Kl(j){M.blockers.delete(j),ae.delete(j)}function Xi(j,V){let Q=M.blockers.get(j)||el;Ie(Q.state==="unblocked"&&V.state==="blocked"||Q.state==="blocked"&&V.state==="blocked"||Q.state==="blocked"&&V.state==="proceeding"||Q.state==="blocked"&&V.state==="unblocked"||Q.state==="proceeding"&&V.state==="unblocked",`Invalid blocker state transition: ${Q.state} -> ${V.state}`);let se=new Map(M.blockers);se.set(j,V),Xe({blockers:se})}function Jl({currentLocation:j,nextLocation:V,historyAction:Q}){if(ae.size===0)return;ae.size>1&&qt(!1,"A router only supports one blocker at a time");let se=Array.from(ae.entries()),[ce,Se]=se[se.length-1],Ee=M.blockers.get(ce);if(!(Ee&&Ee.state==="proceeding")&&Se({currentLocation:j,nextLocation:V,historyAction:Q}))return ce}function va(j){let V=tr(404,{pathname:j}),Q=f||u,{matches:se,route:ce}=bu(Q);return{notFoundMatches:se,route:ce,error:V}}function Gi(j,V,Q){if(_=j,N=V,x=Q||null,!k&&M.navigation===Bp){k=!0;let se=ni(M.location,M.matches);se!=null&&Xe({restoreScrollPosition:se})}return()=>{_=null,N=null,x=null}}function ti(j,V){return x&&x(j,V.map(se=>G5(se,M.loaderData)))||j.key}function qr(j,V){if(_&&N){let Q=ti(j,V);_[Q]=N()}}function ni(j,V){if(_){let Q=ti(j,V),se=_[Q];if(typeof se=="number")return se}return null}function Sr(j,V,Q){if(e.patchRoutesOnNavigation)if(j){if(Object.keys(j[0].params).length>0)return{active:!0,matches:ju(V,Q,h,!0)}}else return{active:!0,matches:ju(V,Q,h,!0)||[]};return{active:!1,matches:null}}async function Wi(j,V,Q,se){if(!e.patchRoutesOnNavigation)return{type:"success",matches:j};let ce=j;for(;;){let Se=f==null,Ee=f||u,be=c;try{await e.patchRoutesOnNavigation({signal:Q,path:V,matches:ce,fetcherKey:se,patch:(de,pe)=>{Q.aborted||ix(de,pe,Ee,be,s,!1)}})}catch(de){return{type:"error",error:de,partialMatches:ce}}finally{Se&&!Q.aborted&&(u=[...u])}if(Q.aborted)return{type:"aborted"};let Te=Va(Ee,V,h);if(Te)return{type:"success",matches:Te};let Ce=ju(Ee,V,h,!0);if(!Ce||ce.length===Ce.length&&ce.every((de,pe)=>de.route.id===Ce[pe].route.id))return{type:"success",matches:null};ce=Ce}}function Zl(j){c={},f=Ml(j,s,void 0,c)}function os(j,V,Q=!1){let se=f==null;ix(j,V,f||u,c,s,Q),se&&(u=[...u],Xe({}))}return F={get basename(){return h},get future(){return y},get state(){return M},get routes(){return u},get window(){return t},initialize:Re,subscribe:De,enableScrollRestoration:Gi,navigate:ir,fetch:ns,revalidate:Fr,createHref:j=>e.history.createHref(j),encodeLocation:j=>e.history.encodeLocation(j),getFetcher:ei,resetFetcher:Zd,deleteFetcher:ef,dispose:Qe,getBlocker:hn,deleteBlocker:Kl,patchRoutes:os,_internalFetchControllers:S,_internalSetRoutes:Zl,_internalSetStateDoNotUseOrYouWillBreakYourApp(j){Xe(j)}},F}function _k(e){return e!=null&&("formData"in e&&e.formData!=null||"body"in e&&e.body!==void 0)}function Nm(e,t,r,i,s,c){let u,f;if(s){u=[];for(let p of t)if(u.push(p),p.route.id===s){f=p;break}}else u=t,f=t[t.length-1];let h=Eg(i||".",Sg(u),ar(e.pathname,r)||e.pathname,c==="path");if(i==null&&(h.search=e.search,h.hash=e.hash),(i==null||i===""||i===".")&&f){let p=Ng(h.search);if(f.route.index&&!p)h.search=h.search?h.search.replace(/^\?/,"?index&"):"?index";else if(!f.route.index&&p){let y=new URLSearchParams(h.search),v=y.getAll("index");y.delete("index"),v.filter(_=>_).forEach(_=>y.append("index",_));let w=y.toString();h.search=w?`?${w}`:""}}return r!=="/"&&(h.pathname=sk({basename:r,pathname:h.pathname})),Qa(h)}function rx(e,t,r){if(!r||!_k(r))return{path:t};if(r.formMethod&&!Hk(r.formMethod))return{path:t,error:tr(405,{method:r.formMethod})};let i=()=>({path:t,error:tr(400,{type:"invalid-body"})}),c=(r.formMethod||"get").toUpperCase(),u=I2(t);if(r.body!==void 0){if(r.formEncType==="text/plain"){if(!Cn(c))return i();let v=typeof r.body=="string"?r.body:r.body instanceof FormData||r.body instanceof URLSearchParams?Array.from(r.body.entries()).reduce((w,[_,x])=>`${w}${_}=${x}
`,""):String(r.body);return{path:t,submission:{formMethod:c,formAction:u,formEncType:r.formEncType,formData:void 0,json:void 0,text:v}}}else if(r.formEncType==="application/json"){if(!Cn(c))return i();try{let v=typeof r.body=="string"?JSON.parse(r.body):r.body;return{path:t,submission:{formMethod:c,formAction:u,formEncType:r.formEncType,formData:void 0,json:v,text:void 0}}}catch{return i()}}}Ie(typeof FormData=="function","FormData is not available in this environment");let f,h;if(r.formData)f=Am(r.formData),h=r.formData;else if(r.body instanceof FormData)f=Am(r.body),h=r.body;else if(r.body instanceof URLSearchParams)f=r.body,h=ux(f);else if(r.body==null)f=new URLSearchParams,h=new FormData;else try{f=new URLSearchParams(r.body),h=ux(f)}catch{return i()}let p={formMethod:c,formAction:u,formEncType:r&&r.formEncType||"application/x-www-form-urlencoded",formData:h,json:void 0,text:void 0};if(Cn(p.formMethod))return{path:t,submission:p};let y=Ja(t);return e&&y.search&&Ng(y.search)&&f.append("index",""),y.search=`?${f}`,{path:Qa(y),submission:p}}function ax(e,t,r,i,s,c,u,f,h,p,y,v,w,_,x,N,k,E,R,O){let B=O?Un(O[1])?O[1].error:O[1].data:void 0,F=s.createURL(c.location),M=s.createURL(h),G;if(y&&c.errors){let _e=Object.keys(c.errors)[0];G=u.findIndex(we=>we.route.id===_e)}else if(O&&Un(O[1])){let _e=O[0];G=u.findIndex(we=>we.route.id===_e)-1}let ie=O?O[1].statusCode:void 0,oe=ie&&ie>=400,fe={currentUrl:F,currentParams:c.matches[0]?.params||{},nextUrl:M,nextParams:u[0].params,...f,actionResult:B,actionStatus:ie},he=u.map((_e,we)=>{let{route:Oe}=_e,S=null;if(G!=null&&we>G?S=!1:Oe.lazy?S=!0:Cg(Oe)?y?S=km(Oe,c.loaderData,c.errors):Sk(c.loaderData,c.matches[we],_e)&&(S=!0):S=!1,S!==null)return Rm(r,i,e,_e,p,t,S);let z=oe?!1:v||F.pathname+F.search===M.pathname+M.search||F.search!==M.search||Ek(c.matches[we],_e),H={...fe,defaultShouldRevalidate:z},Z=bd(_e,H);return Rm(r,i,e,_e,p,t,Z,H)}),ue=[];return x.forEach((_e,we)=>{if(y||!u.some(Y=>Y.route.id===_e.routeId)||_.has(we))return;let Oe=c.fetchers.get(we),S=Oe&&Oe.state!=="idle"&&Oe.data===void 0,z=Va(k,_e.path,E);if(!z){if(R&&S)return;ue.push({key:we,routeId:_e.routeId,path:_e.path,matches:null,match:null,request:null,controller:null});return}if(N.has(we))return;let H=Lu(z,_e.path),Z=new AbortController,re=jo(s,_e.path,Z.signal),A=null;if(w.has(we))w.delete(we),A=qo(r,i,re,z,H,p,t);else if(S)v&&(A=qo(r,i,re,z,H,p,t));else{let Y={...fe,defaultShouldRevalidate:oe?!1:v};bd(H,Y)&&(A=qo(r,i,re,z,H,p,t,Y))}A&&ue.push({key:we,routeId:_e.routeId,path:_e.path,matches:A,match:H,request:re,controller:Z})}),{dsMatches:he,revalidatingFetchers:ue}}function Cg(e){return e.loader!=null||e.middleware!=null&&e.middleware.length>0}function km(e,t,r){if(e.lazy)return!0;if(!Cg(e))return!1;let i=t!=null&&e.id in t,s=r!=null&&r[e.id]!==void 0;return!i&&s?!1:typeof e.loader=="function"&&e.loader.hydrate===!0?!0:!i&&!s}function Sk(e,t,r){let i=!t||r.route.id!==t.route.id,s=!e.hasOwnProperty(r.route.id);return i||s}function Ek(e,t){let r=e.route.path;return e.pathname!==t.pathname||r!=null&&r.endsWith("*")&&e.params["*"]!==t.params["*"]}function bd(e,t){if(e.route.shouldRevalidate){let r=e.route.shouldRevalidate(t);if(typeof r=="boolean")return r}return t.defaultShouldRevalidate}function ix(e,t,r,i,s,c){let u;if(e){let p=i[e];Ie(p,`No route found to patch children into: routeId = ${e}`),p.children||(p.children=[]),u=p.children}else u=r;let f=[],h=[];if(t.forEach(p=>{let y=u.find(v=>$2(p,v));y?h.push({existingRoute:y,newRoute:p}):f.push(p)}),f.length>0){let p=Ml(f,s,[e||"_","patch",String(u?.length||"0")],i);u.push(...p)}if(c&&h.length>0)for(let p=0;p<h.length;p++){let{existingRoute:y,newRoute:v}=h[p],w=y,[_]=Ml([v],s,[],{},!0);Object.assign(w,{element:_.element?_.element:w.element,errorElement:_.errorElement?_.errorElement:w.errorElement,hydrateFallbackElement:_.hydrateFallbackElement?_.hydrateFallbackElement:w.hydrateFallbackElement})}}function $2(e,t){return"id"in e&&"id"in t&&e.id===t.id?!0:e.index===t.index&&e.path===t.path&&e.caseSensitive===t.caseSensitive?(!e.children||e.children.length===0)&&(!t.children||t.children.length===0)?!0:e.children.every((r,i)=>t.children?.some(s=>$2(r,s))):!1}var ox=new WeakMap,q2=({key:e,route:t,manifest:r,mapRouteProperties:i})=>{let s=r[t.id];if(Ie(s,"No route found in manifest"),!s.lazy||typeof s.lazy!="object")return;let c=s.lazy[e];if(!c)return;let u=ox.get(s);u||(u={},ox.set(s,u));let f=u[e];if(f)return f;let h=(async()=>{let p=V5(e),v=s[e]!==void 0&&e!=="hasErrorBoundary";if(p)qt(!p,"Route property "+e+" is not a supported lazy route property. This property will be ignored."),u[e]=Promise.resolve();else if(v)qt(!1,`Route "${s.id}" has a static property "${e}" defined. The lazy property will be ignored.`);else{let w=await c();w!=null&&(Object.assign(s,{[e]:w}),Object.assign(s,i(s)))}typeof s.lazy=="object"&&(s.lazy[e]=void 0,Object.values(s.lazy).every(w=>w===void 0)&&(s.lazy=void 0))})();return u[e]=h,h},sx=new WeakMap;function Tk(e,t,r,i,s){let c=r[e.id];if(Ie(c,"No route found in manifest"),!e.lazy)return{lazyRoutePromise:void 0,lazyHandlerPromise:void 0};if(typeof e.lazy=="function"){let y=sx.get(c);if(y)return{lazyRoutePromise:y,lazyHandlerPromise:y};let v=(async()=>{Ie(typeof e.lazy=="function","No lazy route function found");let w=await e.lazy(),_={};for(let x in w){let N=w[x];if(N===void 0)continue;let k=I5(x),R=c[x]!==void 0&&x!=="hasErrorBoundary";k?qt(!k,"Route property "+x+" is not a supported property to be returned from a lazy route function. This property will be ignored."):R?qt(!R,`Route "${c.id}" has a static property "${x}" defined but its lazy function is also returning a value for this property. The lazy route property "${x}" will be ignored.`):_[x]=N}Object.assign(c,_),Object.assign(c,{...i(c),lazy:void 0})})();return sx.set(c,v),v.catch(()=>{}),{lazyRoutePromise:v,lazyHandlerPromise:v}}let u=Object.keys(e.lazy),f=[],h;for(let y of u){if(s&&s.includes(y))continue;let v=q2({key:y,route:e,manifest:r,mapRouteProperties:i});v&&(f.push(v),y===t&&(h=v))}let p=f.length>0?Promise.all(f).then(()=>{}):void 0;return p?.catch(()=>{}),h?.catch(()=>{}),{lazyRoutePromise:p,lazyHandlerPromise:h}}async function lx(e){let t=e.matches.filter(s=>s.shouldLoad),r={};return(await Promise.all(t.map(s=>s.resolve()))).forEach((s,c)=>{r[t[c].route.id]=s}),r}async function Ck(e){return e.matches.some(t=>t.route.middleware)?Y2(e,()=>lx(e)):lx(e)}function Y2(e,t){return Nk(e,t,i=>i,jk,r);function r(i,s,c){if(c)return Promise.resolve(Object.assign(c.value,{[s]:{type:"error",result:i}}));{let{matches:u}=e,f=Math.min(Math.max(u.findIndex(p=>p.route.id===s),0),Math.max(u.findIndex(p=>p.unstable_shouldCallHandler()),0)),h=Pa(u,u[f].route.id).route.id;return Promise.resolve({[h]:{type:"error",result:i}})}}}async function Nk(e,t,r,i,s){let{matches:c,request:u,params:f,context:h}=e,p=c.flatMap(v=>v.route.middleware?v.route.middleware.map(w=>[v.route.id,w]):[]);return await V2({request:u,params:f,context:h},p,t,r,i,s)}async function V2(e,t,r,i,s,c,u=0){let{request:f}=e;if(f.signal.aborted)throw f.signal.reason??new Error(`Request aborted: ${f.method} ${f.url}`);let h=t[u];if(!h)return await r();let[p,y]=h,v,w=async()=>{if(v)throw new Error("You may only call `next()` once per middleware");try{return v={value:await V2(e,t,r,i,s,c,u+1)},v.value}catch(_){return v={value:await c(_,p,v)},v.value}};try{let _=await y(e,w),x=_!=null?i(_):void 0;return s(x)?x:v?x??v.value:(v={value:await w()},v.value)}catch(_){return await c(_,p,v)}}function P2(e,t,r,i,s){let c=q2({key:"middleware",route:i.route,manifest:t,mapRouteProperties:e}),u=Tk(i.route,Cn(r.method)?"action":"loader",t,e,s);return{middleware:c,route:u.lazyRoutePromise,handler:u.lazyHandlerPromise}}function Rm(e,t,r,i,s,c,u,f=null){let h=!1,p=P2(e,t,r,i,s);return{...i,_lazyPromises:p,shouldLoad:u,unstable_shouldRevalidateArgs:f,unstable_shouldCallHandler(y){return h=!0,f?typeof y=="boolean"?bd(i,{...f,defaultShouldRevalidate:y}):bd(i,f):u},resolve(y){let{lazy:v,loader:w,middleware:_}=i.route,x=h||u||y&&!Cn(r.method)&&(v||w),N=_&&_.length>0&&!w&&!v;return x&&!N?Rk({request:r,match:i,lazyHandlerPromise:p?.handler,lazyRoutePromise:p?.route,handlerOverride:y,scopedContext:c}):Promise.resolve({type:"data",result:void 0})}}}function qo(e,t,r,i,s,c,u,f=null){return i.map(h=>h.route.id!==s.route.id?{...h,shouldLoad:!1,unstable_shouldRevalidateArgs:f,unstable_shouldCallHandler:()=>!1,_lazyPromises:P2(e,t,r,h,c),resolve:()=>Promise.resolve({type:"data",result:void 0})}:Rm(e,t,r,h,c,u,!0,f))}async function kk(e,t,r,i,s,c){r.some(p=>p._lazyPromises?.middleware)&&await Promise.all(r.map(p=>p._lazyPromises?.middleware));let u={request:t,params:r[0].params,context:s,matches:r},h=await e({...u,fetcherKey:i,runClientMiddleware:p=>{let y=u;return Y2(y,()=>p({...y,fetcherKey:i,runClientMiddleware:()=>{throw new Error("Cannot call `runClientMiddleware()` from within an `runClientMiddleware` handler")}}))}});try{await Promise.all(r.flatMap(p=>[p._lazyPromises?.handler,p._lazyPromises?.route]))}catch{}return h}async function Rk({request:e,match:t,lazyHandlerPromise:r,lazyRoutePromise:i,handlerOverride:s,scopedContext:c}){let u,f,h=Cn(e.method),p=h?"action":"loader",y=v=>{let w,_=new Promise((k,E)=>w=E);f=()=>w(),e.signal.addEventListener("abort",f);let x=k=>typeof v!="function"?Promise.reject(new Error(`You cannot call the handler for a route which defines a boolean "${p}" [routeId: ${t.route.id}]`)):v({request:e,params:t.params,context:c},...k!==void 0?[k]:[]),N=(async()=>{try{return{type:"data",result:await(s?s(E=>x(E)):x())}}catch(k){return{type:"error",result:k}}})();return Promise.race([N,_])};try{let v=h?t.route.action:t.route.loader;if(r||i)if(v){let w,[_]=await Promise.all([y(v).catch(x=>{w=x}),r,i]);if(w!==void 0)throw w;u=_}else{await r;let w=h?t.route.action:t.route.loader;if(w)[u]=await Promise.all([y(w),i]);else if(p==="action"){let _=new URL(e.url),x=_.pathname+_.search;throw tr(405,{method:e.method,pathname:x,routeId:t.route.id})}else return{type:"data",result:void 0}}else if(v)u=await y(v);else{let w=new URL(e.url),_=w.pathname+w.search;throw tr(404,{pathname:_})}}catch(v){return{type:"error",result:v}}finally{f&&e.signal.removeEventListener("abort",f)}return u}async function Ak(e){let t=e.headers.get("Content-Type");return t&&/\bapplication\/json\b/.test(t)?e.body==null?null:e.json():e.text()}async function Ok(e){let{result:t,type:r}=e;if(X2(t)){let i;try{i=await Ak(t)}catch(s){return{type:"error",error:s}}return r==="error"?{type:"error",error:new yd(t.status,t.statusText,i),statusCode:t.status,headers:t.headers}:{type:"data",data:i,statusCode:t.status,headers:t.headers}}return r==="error"?px(t)?t.data instanceof Error?{type:"error",error:t.data,statusCode:t.init?.status,headers:t.init?.headers?new Headers(t.init.headers):void 0}:{type:"error",error:new yd(t.init?.status||500,void 0,t.data),statusCode:zl(t)?t.status:void 0,headers:t.init?.headers?new Headers(t.init.headers):void 0}:{type:"error",error:t,statusCode:zl(t)?t.status:void 0}:px(t)?{type:"data",data:t.data,statusCode:t.init?.status,headers:t.init?.headers?new Headers(t.init.headers):void 0}:{type:"data",data:t}}function Mk(e,t,r,i,s){let c=e.headers.get("Location");if(Ie(c,"Redirects returned/thrown from loaders/actions must have a Location header"),!Tg(c)){let u=i.slice(0,i.findIndex(f=>f.route.id===r)+1);c=Nm(new URL(t.url),u,s,c),e.headers.set("Location",c)}return e}function cx(e,t,r){if(Tg(e)){let i=e,s=i.startsWith("//")?new URL(t.protocol+i):new URL(i),c=ar(s.pathname,r)!=null;if(s.origin===t.origin&&c)return s.pathname+s.search+s.hash}return e}function jo(e,t,r,i){let s=e.createURL(I2(t)).toString(),c={signal:r};if(i&&Cn(i.formMethod)){let{formMethod:u,formEncType:f}=i;c.method=u.toUpperCase(),f==="application/json"?(c.headers=new Headers({"Content-Type":f}),c.body=JSON.stringify(i.json)):f==="text/plain"?c.body=i.text:f==="application/x-www-form-urlencoded"&&i.formData?c.body=Am(i.formData):c.body=i.formData}return new Request(s,c)}function Am(e){let t=new URLSearchParams;for(let[r,i]of e.entries())t.append(r,typeof i=="string"?i:i.name);return t}function ux(e){let t=new FormData;for(let[r,i]of e.entries())t.append(r,i);return t}function zk(e,t,r,i=!1,s=!1){let c={},u=null,f,h=!1,p={},y=r&&Un(r[1])?r[1].error:void 0;return e.forEach(v=>{if(!(v.route.id in t))return;let w=v.route.id,_=t[w];if(Ie(!Ai(_),"Cannot handle redirect results in processLoaderData"),Un(_)){let x=_.error;if(y!==void 0&&(x=y,y=void 0),u=u||{},s)u[w]=x;else{let N=Pa(e,w);u[N.route.id]==null&&(u[N.route.id]=x)}i||(c[w]=F2),h||(h=!0,f=zl(_.error)?_.error.status:500),_.headers&&(p[w]=_.headers)}else c[w]=_.data,_.statusCode&&_.statusCode!==200&&!h&&(f=_.statusCode),_.headers&&(p[w]=_.headers)}),y!==void 0&&r&&(u={[r[0]]:y},r[2]&&(c[r[2]]=void 0)),{loaderData:c,errors:u,statusCode:f||200,loaderHeaders:p}}function dx(e,t,r,i,s,c){let{loaderData:u,errors:f}=zk(t,r,i);return s.filter(h=>!h.matches||h.matches.some(p=>p.shouldLoad)).forEach(h=>{let{key:p,match:y,controller:v}=h;if(v&&v.signal.aborted)return;let w=c[p];if(Ie(w,"Did not find corresponding fetcher result"),Un(w)){let _=Pa(e.matches,y?.route.id);f&&f[_.route.id]||(f={...f,[_.route.id]:w.error}),e.fetchers.delete(p)}else if(Ai(w))Ie(!1,"Unhandled fetcher revalidation redirect");else{let _=ca(w.data);e.fetchers.set(p,_)}}),{loaderData:u,errors:f}}function fx(e,t,r,i){let s=Object.entries(t).filter(([,c])=>c!==F2).reduce((c,[u,f])=>(c[u]=f,c),{});for(let c of r){let u=c.route.id;if(!t.hasOwnProperty(u)&&e.hasOwnProperty(u)&&c.route.loader&&(s[u]=e[u]),i&&i.hasOwnProperty(u))break}return s}function hx(e){return e?Un(e[1])?{actionData:{}}:{actionData:{[e[0]]:e[1].data}}:{}}function Pa(e,t){return(t?e.slice(0,e.findIndex(i=>i.route.id===t)+1):[...e]).reverse().find(i=>i.route.hasErrorBoundary===!0)||e[0]}function bu(e){let t=e.length===1?e[0]:e.find(r=>r.index||!r.path||r.path==="/")||{id:"__shim-error-route__"};return{matches:[{params:{},pathname:"",pathnameBase:"",route:t}],route:t}}function tr(e,{pathname:t,routeId:r,method:i,type:s,message:c}={}){let u="Unknown Server Error",f="Unknown @remix-run/router error";return e===400?(u="Bad Request",i&&t&&r?f=`You made a ${i} request to "${t}" but did not provide a \`loader\` for route "${r}", so there is no way to handle the request.`:s==="invalid-body"&&(f="Unable to encode submission body")):e===403?(u="Forbidden",f=`Route "${r}" does not match URL "${t}"`):e===404?(u="Not Found",f=`No route matches URL "${t}"`):e===405&&(u="Method Not Allowed",i&&t&&r?f=`You made a ${i.toUpperCase()} request to "${t}" but did not provide an \`action\` for route "${r}", so there is no way to handle the request.`:i&&(f=`Invalid request method "${i.toUpperCase()}"`)),new yd(e||500,u,new Error(f),!0)}function wu(e){let t=Object.entries(e);for(let r=t.length-1;r>=0;r--){let[i,s]=t[r];if(Ai(s))return{key:i,result:s}}}function I2(e){let t=typeof e=="string"?Ja(e):e;return Qa({...t,hash:""})}function Dk(e,t){return e.pathname!==t.pathname||e.search!==t.search?!1:e.hash===""?t.hash!=="":e.hash===t.hash?!0:t.hash!==""}function jk(e){return e!=null&&typeof e=="object"&&Object.entries(e).every(([t,r])=>typeof t=="string"&&Lk(r))}function Lk(e){return e!=null&&typeof e=="object"&&"type"in e&&"result"in e&&(e.type==="data"||e.type==="error")}function Uk(e){return X2(e.result)&&gk.has(e.result.status)}function Un(e){return e.type==="error"}function Ai(e){return(e&&e.type)==="redirect"}function px(e){return typeof e=="object"&&e!=null&&"type"in e&&"data"in e&&"init"in e&&e.type==="DataWithResponseInit"}function X2(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.headers=="object"&&typeof e.body<"u"}function Hk(e){return mk.has(e.toUpperCase())}function Cn(e){return hk.has(e.toUpperCase())}function Ng(e){return new URLSearchParams(e).getAll("index").some(t=>t==="")}function Lu(e,t){let r=typeof t=="string"?Ja(t).search:t.search;if(e[e.length-1].route.index&&Ng(r||""))return e[e.length-1];let i=U2(e);return i[i.length-1]}function mx(e){let{formMethod:t,formAction:r,formEncType:i,text:s,formData:c,json:u}=e;if(!(!t||!r||!i)){if(s!=null)return{formMethod:t,formAction:r,formEncType:i,formData:void 0,json:void 0,text:s};if(c!=null)return{formMethod:t,formAction:r,formEncType:i,formData:c,json:void 0,text:void 0};if(u!==void 0)return{formMethod:t,formAction:r,formEncType:i,formData:void 0,json:u,text:void 0}}}function Fp(e,t){return t?{state:"loading",location:e,formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text}:{state:"loading",location:e,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0}}function Bk(e,t){return{state:"submitting",location:e,formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text}}function tl(e,t){return e?{state:"loading",formMethod:e.formMethod,formAction:e.formAction,formEncType:e.formEncType,formData:e.formData,json:e.json,text:e.text,data:t}:{state:"loading",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:t}}function Fk(e,t){return{state:"submitting",formMethod:e.formMethod,formAction:e.formAction,formEncType:e.formEncType,formData:e.formData,json:e.json,text:e.text,data:t?t.data:void 0}}function ca(e){return{state:"idle",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:e}}function $k(e,t){try{let r=e.sessionStorage.getItem(B2);if(r){let i=JSON.parse(r);for(let[s,c]of Object.entries(i||{}))c&&Array.isArray(c)&&t.set(s,new Set(c||[]))}}catch{}}function qk(e,t){if(t.size>0){let r={};for(let[i,s]of t)r[i]=[...s];try{e.sessionStorage.setItem(B2,JSON.stringify(r))}catch(i){qt(!1,`Failed to save applied view transitions in sessionStorage (${i}).`)}}}function Yk(){let e,t,r=new Promise((i,s)=>{e=async c=>{i(c);try{await r}catch{}},t=async c=>{s(c);try{await r}catch{}}});return{promise:r,resolve:e,reject:t}}var Vi=U.createContext(null);Vi.displayName="DataRouter";var $l=U.createContext(null);$l.displayName="DataRouterState";U.createContext(!1);var kg=U.createContext({isTransitioning:!1});kg.displayName="ViewTransition";var G2=U.createContext(new Map);G2.displayName="Fetchers";var Vk=U.createContext(null);Vk.displayName="Await";var Hr=U.createContext(null);Hr.displayName="Navigation";var Bd=U.createContext(null);Bd.displayName="Location";var wr=U.createContext({outlet:null,matches:[],isDataRoute:!1});wr.displayName="Route";var Rg=U.createContext(null);Rg.displayName="RouteError";function Pk(e,{relative:t}={}){Ie(ql(),"useHref() may be used only in the context of a <Router> component.");let{basename:r,navigator:i}=U.useContext(Hr),{hash:s,pathname:c,search:u}=Yl(e,{relative:t}),f=c;return r!=="/"&&(f=c==="/"?r:jr([r,c])),i.createHref({pathname:f,search:u,hash:s})}function ql(){return U.useContext(Bd)!=null}function Pi(){return Ie(ql(),"useLocation() may be used only in the context of a <Router> component."),U.useContext(Bd).location}var W2="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Q2(e){U.useContext(Hr).static||U.useLayoutEffect(e)}function xr(){let{isDataRoute:e}=U.useContext(wr);return e?iR():Ik()}function Ik(){Ie(ql(),"useNavigate() may be used only in the context of a <Router> component.");let e=U.useContext(Vi),{basename:t,navigator:r}=U.useContext(Hr),{matches:i}=U.useContext(wr),{pathname:s}=Pi(),c=JSON.stringify(Sg(i)),u=U.useRef(!1);return Q2(()=>{u.current=!0}),U.useCallback((h,p={})=>{if(qt(u.current,W2),!u.current)return;if(typeof h=="number"){r.go(h);return}let y=Eg(h,JSON.parse(c),s,p.relative==="path");e==null&&t!=="/"&&(y.pathname=y.pathname==="/"?t:jr([t,y.pathname])),(p.replace?r.replace:r.push)(y,p.state,p)},[t,r,c,s,e])}var K2=U.createContext(null);function Ag(){return U.useContext(K2)}function Xk(e){let t=U.useContext(wr).outlet;return U.useMemo(()=>t&&U.createElement(K2.Provider,{value:e},t),[t,e])}function Fd(){let{matches:e}=U.useContext(wr),t=e[e.length-1];return t?t.params:{}}function Yl(e,{relative:t}={}){let{matches:r}=U.useContext(wr),{pathname:i}=Pi(),s=JSON.stringify(Sg(r));return U.useMemo(()=>Eg(e,JSON.parse(s),i,t==="path"),[e,s,i,t])}function Gk(e,t,r,i,s){Ie(ql(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:c}=U.useContext(Hr),{matches:u}=U.useContext(wr),f=u[u.length-1],h=f?f.params:{},p=f?f.pathname:"/",y=f?f.pathnameBase:"/",v=f&&f.route;{let R=v&&v.path||"";J2(p,!v||R.endsWith("*")||R.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${p}" (under <Route path="${R}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${R}"> to <Route path="${R==="/"?"*":`${R}/*`}">.`)}let w=Pi(),_;_=w;let x=_.pathname||"/",N=x;if(y!=="/"){let R=y.replace(/^\//,"").split("/");N="/"+x.replace(/^\//,"").split("/").slice(R.length).join("/")}let k=Va(e,{pathname:N});return qt(v||k!=null,`No routes matched location "${_.pathname}${_.search}${_.hash}" `),qt(k==null||k[k.length-1].route.element!==void 0||k[k.length-1].route.Component!==void 0||k[k.length-1].route.lazy!==void 0,`Matched leaf route at location "${_.pathname}${_.search}${_.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`),Zk(k&&k.map(R=>Object.assign({},R,{params:Object.assign({},h,R.params),pathname:jr([y,c.encodeLocation?c.encodeLocation(R.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:R.pathname]),pathnameBase:R.pathnameBase==="/"?y:jr([y,c.encodeLocation?c.encodeLocation(R.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:R.pathnameBase])})),u,r,i,s)}function Wk(){let e=aR(),t=zl(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),r=e instanceof Error?e.stack:null,i="rgba(200,200,200, 0.5)",s={padding:"0.5rem",backgroundColor:i},c={padding:"2px 4px",backgroundColor:i},u=null;return console.error("Error handled by React Router default ErrorBoundary:",e),u=U.createElement(U.Fragment,null,U.createElement("p",null,"💿 Hey developer 👋"),U.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",U.createElement("code",{style:c},"ErrorBoundary")," or"," ",U.createElement("code",{style:c},"errorElement")," prop on your route.")),U.createElement(U.Fragment,null,U.createElement("h2",null,"Unexpected Application Error!"),U.createElement("h3",{style:{fontStyle:"italic"}},t),r?U.createElement("pre",{style:s},r):null,u)}var Qk=U.createElement(Wk,null),Kk=class extends U.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:t.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.unstable_onError?this.props.unstable_onError(e,t):console.error("React Router caught the following error during render",e)}render(){return this.state.error!==void 0?U.createElement(wr.Provider,{value:this.props.routeContext},U.createElement(Rg.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function Jk({routeContext:e,match:t,children:r}){let i=U.useContext(Vi);return i&&i.static&&i.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=t.route.id),U.createElement(wr.Provider,{value:e},r)}function Zk(e,t=[],r=null,i=null,s=null){if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let c=e,u=r?.errors;if(u!=null){let p=c.findIndex(y=>y.route.id&&u?.[y.route.id]!==void 0);Ie(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(u).join(",")}`),c=c.slice(0,Math.min(c.length,p+1))}let f=!1,h=-1;if(r)for(let p=0;p<c.length;p++){let y=c[p];if((y.route.HydrateFallback||y.route.hydrateFallbackElement)&&(h=p),y.route.id){let{loaderData:v,errors:w}=r,_=y.route.loader&&!v.hasOwnProperty(y.route.id)&&(!w||w[y.route.id]===void 0);if(y.route.lazy||_){f=!0,h>=0?c=c.slice(0,h+1):c=[c[0]];break}}}return c.reduceRight((p,y,v)=>{let w,_=!1,x=null,N=null;r&&(w=u&&y.route.id?u[y.route.id]:void 0,x=y.route.errorElement||Qk,f&&(h<0&&v===0?(J2("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),_=!0,N=null):h===v&&(_=!0,N=y.route.hydrateFallbackElement||null)));let k=t.concat(c.slice(0,v+1)),E=()=>{let R;return w?R=x:_?R=N:y.route.Component?R=U.createElement(y.route.Component,null):y.route.element?R=y.route.element:R=p,U.createElement(Jk,{match:y,routeContext:{outlet:p,matches:k,isDataRoute:r!=null},children:R})};return r&&(y.route.ErrorBoundary||y.route.errorElement||v===0)?U.createElement(Kk,{location:r.location,revalidation:r.revalidation,component:x,error:w,children:E(),routeContext:{outlet:null,matches:k,isDataRoute:!0},unstable_onError:i}):E()},null)}function Og(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function eR(e){let t=U.useContext(Vi);return Ie(t,Og(e)),t}function tR(e){let t=U.useContext($l);return Ie(t,Og(e)),t}function nR(e){let t=U.useContext(wr);return Ie(t,Og(e)),t}function Mg(e){let t=nR(e),r=t.matches[t.matches.length-1];return Ie(r.route.id,`${e} can only be used on routes that contain a unique "id"`),r.route.id}function rR(){return Mg("useRouteId")}function aR(){let e=U.useContext(Rg),t=tR("useRouteError"),r=Mg("useRouteError");return e!==void 0?e:t.errors?.[r]}function iR(){let{router:e}=eR("useNavigate"),t=Mg("useNavigate"),r=U.useRef(!1);return Q2(()=>{r.current=!0}),U.useCallback(async(s,c={})=>{qt(r.current,W2),r.current&&(typeof s=="number"?e.navigate(s):await e.navigate(s,{fromRouteId:t,...c}))},[e,t])}var gx={};function J2(e,t,r){!t&&!gx[e]&&(gx[e]=!0,qt(!1,r))}var vx={};function yx(e,t){!e&&!vx[t]&&(vx[t]=!0,console.warn(t))}function oR(e){let t={hasErrorBoundary:e.hasErrorBoundary||e.ErrorBoundary!=null||e.errorElement!=null};return e.Component&&(e.element&&qt(!1,"You should not include both `Component` and `element` on your route - `Component` will be used."),Object.assign(t,{element:U.createElement(e.Component),Component:void 0})),e.HydrateFallback&&(e.hydrateFallbackElement&&qt(!1,"You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - `HydrateFallback` will be used."),Object.assign(t,{hydrateFallbackElement:U.createElement(e.HydrateFallback),HydrateFallback:void 0})),e.ErrorBoundary&&(e.errorElement&&qt(!1,"You should not include both `ErrorBoundary` and `errorElement` on your route - `ErrorBoundary` will be used."),Object.assign(t,{errorElement:U.createElement(e.ErrorBoundary),ErrorBoundary:void 0})),t}var sR=["HydrateFallback","hydrateFallbackElement"],lR=class{constructor(){this.status="pending",this.promise=new Promise((e,t)=>{this.resolve=r=>{this.status==="pending"&&(this.status="resolved",e(r))},this.reject=r=>{this.status==="pending"&&(this.status="rejected",t(r))}})}};function cR({router:e,flushSync:t,unstable_onError:r}){let[i,s]=U.useState(e.state),[c,u]=U.useState(),[f,h]=U.useState({isTransitioning:!1}),[p,y]=U.useState(),[v,w]=U.useState(),[_,x]=U.useState(),N=U.useRef(new Map),k=U.useCallback(F=>{s(M=>(F.errors&&r&&Object.entries(F.errors).forEach(([G,ie])=>{M.errors?.[G]!==ie&&r(ie)}),F))},[r]),E=U.useCallback((F,{deletedFetchers:M,flushSync:G,viewTransitionOpts:ie})=>{F.fetchers.forEach((fe,he)=>{fe.data!==void 0&&N.current.set(he,fe.data)}),M.forEach(fe=>N.current.delete(fe)),yx(G===!1||t!=null,'You provided the `flushSync` option to a router update, but you are not using the `<RouterProvider>` from `react-router/dom` so `ReactDOM.flushSync()` is unavailable.  Please update your app to `import { RouterProvider } from "react-router/dom"` and ensure you have `react-dom` installed as a dependency to use the `flushSync` option.');let oe=e.window!=null&&e.window.document!=null&&typeof e.window.document.startViewTransition=="function";if(yx(ie==null||oe,"You provided the `viewTransition` option to a router update, but you do not appear to be running in a DOM environment as `window.startViewTransition` is not available."),!ie||!oe){t&&G?t(()=>k(F)):U.startTransition(()=>k(F));return}if(t&&G){t(()=>{v&&(p&&p.resolve(),v.skipTransition()),h({isTransitioning:!0,flushSync:!0,currentLocation:ie.currentLocation,nextLocation:ie.nextLocation})});let fe=e.window.document.startViewTransition(()=>{t(()=>k(F))});fe.finished.finally(()=>{t(()=>{y(void 0),w(void 0),u(void 0),h({isTransitioning:!1})})}),t(()=>w(fe));return}v?(p&&p.resolve(),v.skipTransition(),x({state:F,currentLocation:ie.currentLocation,nextLocation:ie.nextLocation})):(u(F),h({isTransitioning:!0,flushSync:!1,currentLocation:ie.currentLocation,nextLocation:ie.nextLocation}))},[e.window,t,v,p,k]);U.useLayoutEffect(()=>e.subscribe(E),[e,E]),U.useEffect(()=>{f.isTransitioning&&!f.flushSync&&y(new lR)},[f]),U.useEffect(()=>{if(p&&c&&e.window){let F=c,M=p.promise,G=e.window.document.startViewTransition(async()=>{U.startTransition(()=>k(F)),await M});G.finished.finally(()=>{y(void 0),w(void 0),u(void 0),h({isTransitioning:!1})}),w(G)}},[c,p,e.window,k]),U.useEffect(()=>{p&&c&&i.location.key===c.location.key&&p.resolve()},[p,v,i.location,c]),U.useEffect(()=>{!f.isTransitioning&&_&&(u(_.state),h({isTransitioning:!0,flushSync:!1,currentLocation:_.currentLocation,nextLocation:_.nextLocation}),x(void 0))},[f.isTransitioning,_]);let R=U.useMemo(()=>({createHref:e.createHref,encodeLocation:e.encodeLocation,go:F=>e.navigate(F),push:(F,M,G)=>e.navigate(F,{state:M,preventScrollReset:G?.preventScrollReset}),replace:(F,M,G)=>e.navigate(F,{replace:!0,state:M,preventScrollReset:G?.preventScrollReset})}),[e]),O=e.basename||"/",B=U.useMemo(()=>({router:e,navigator:R,static:!1,basename:O,unstable_onError:r}),[e,R,O,r]);return U.createElement(U.Fragment,null,U.createElement(Vi.Provider,{value:B},U.createElement($l.Provider,{value:i},U.createElement(G2.Provider,{value:N.current},U.createElement(kg.Provider,{value:f},U.createElement(hR,{basename:O,location:i.location,navigationType:i.historyAction,navigator:R},U.createElement(uR,{routes:e.routes,future:e.future,state:i,unstable_onError:r})))))),null)}var uR=U.memo(dR);function dR({routes:e,future:t,state:r,unstable_onError:i}){return Gk(e,void 0,r,i,t)}function fR(e){return Xk(e.context)}function hR({basename:e="/",children:t=null,location:r,navigationType:i="POP",navigator:s,static:c=!1}){Ie(!ql(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let u=e.replace(/^\/*/,"/"),f=U.useMemo(()=>({basename:u,navigator:s,static:c,future:{}}),[u,s,c]);typeof r=="string"&&(r=Ja(r));let{pathname:h="/",search:p="",hash:y="",state:v=null,key:w="default"}=r,_=U.useMemo(()=>{let x=ar(h,u);return x==null?null:{location:{pathname:x,search:p,hash:y,state:v,key:w},navigationType:i}},[u,h,p,y,v,w,i]);return qt(_!=null,`<Router basename="${u}"> is not able to match the URL "${h}${p}${y}" because it does not start with the basename, so the <Router> won't render anything.`),_==null?null:U.createElement(Hr.Provider,{value:f},U.createElement(Bd.Provider,{children:t,value:_}))}var Uu="get",Hu="application/x-www-form-urlencoded";function $d(e){return e!=null&&typeof e.tagName=="string"}function pR(e){return $d(e)&&e.tagName.toLowerCase()==="button"}function mR(e){return $d(e)&&e.tagName.toLowerCase()==="form"}function gR(e){return $d(e)&&e.tagName.toLowerCase()==="input"}function vR(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function yR(e,t){return e.button===0&&(!t||t==="_self")&&!vR(e)}var xu=null;function bR(){if(xu===null)try{new FormData(document.createElement("form"),0),xu=!1}catch{xu=!0}return xu}var wR=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function $p(e){return e!=null&&!wR.has(e)?(qt(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Hu}"`),null):e}function xR(e,t){let r,i,s,c,u;if(mR(e)){let f=e.getAttribute("action");i=f?ar(f,t):null,r=e.getAttribute("method")||Uu,s=$p(e.getAttribute("enctype"))||Hu,c=new FormData(e)}else if(pR(e)||gR(e)&&(e.type==="submit"||e.type==="image")){let f=e.form;if(f==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let h=e.getAttribute("formaction")||f.getAttribute("action");if(i=h?ar(h,t):null,r=e.getAttribute("formmethod")||f.getAttribute("method")||Uu,s=$p(e.getAttribute("formenctype"))||$p(f.getAttribute("enctype"))||Hu,c=new FormData(f,e),!bR()){let{name:p,type:y,value:v}=e;if(y==="image"){let w=p?`${p}.`:"";c.append(`${w}x`,"0"),c.append(`${w}y`,"0")}else p&&c.append(p,v)}}else{if($d(e))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');r=Uu,i=null,s=Hu,u=e}return c&&s==="text/plain"&&(u=c,c=void 0),{action:i,method:r.toLowerCase(),encType:s,formData:c,body:u}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function zg(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function _R(e,t,r){let i=typeof e=="string"?new URL(e,typeof window>"u"?"server://singlefetch/":window.location.origin):e;return i.pathname==="/"?i.pathname=`_root.${r}`:t&&ar(i.pathname,t)==="/"?i.pathname=`${t.replace(/\/$/,"")}/_root.${r}`:i.pathname=`${i.pathname.replace(/\/$/,"")}.${r}`,i}async function SR(e,t){if(e.id in t)return t[e.id];try{let r=await import(e.module);return t[e.id]=r,r}catch(r){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(r),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function ER(e){return e==null?!1:e.href==null?e.rel==="preload"&&typeof e.imageSrcSet=="string"&&typeof e.imageSizes=="string":typeof e.rel=="string"&&typeof e.href=="string"}async function TR(e,t,r){let i=await Promise.all(e.map(async s=>{let c=t.routes[s.route.id];if(c){let u=await SR(c,r);return u.links?u.links():[]}return[]}));return RR(i.flat(1).filter(ER).filter(s=>s.rel==="stylesheet"||s.rel==="preload").map(s=>s.rel==="stylesheet"?{...s,rel:"prefetch",as:"style"}:{...s,rel:"prefetch"}))}function bx(e,t,r,i,s,c){let u=(h,p)=>r[p]?h.route.id!==r[p].route.id:!0,f=(h,p)=>r[p].pathname!==h.pathname||r[p].route.path?.endsWith("*")&&r[p].params["*"]!==h.params["*"];return c==="assets"?t.filter((h,p)=>u(h,p)||f(h,p)):c==="data"?t.filter((h,p)=>{let y=i.routes[h.route.id];if(!y||!y.hasLoader)return!1;if(u(h,p)||f(h,p))return!0;if(h.route.shouldRevalidate){let v=h.route.shouldRevalidate({currentUrl:new URL(s.pathname+s.search+s.hash,window.origin),currentParams:r[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:h.params,defaultShouldRevalidate:!0});if(typeof v=="boolean")return v}return!0}):[]}function CR(e,t,{includeHydrateFallback:r}={}){return NR(e.map(i=>{let s=t.routes[i.route.id];if(!s)return[];let c=[s.module];return s.clientActionModule&&(c=c.concat(s.clientActionModule)),s.clientLoaderModule&&(c=c.concat(s.clientLoaderModule)),r&&s.hydrateFallbackModule&&(c=c.concat(s.hydrateFallbackModule)),s.imports&&(c=c.concat(s.imports)),c}).flat(1))}function NR(e){return[...new Set(e)]}function kR(e){let t={},r=Object.keys(e).sort();for(let i of r)t[i]=e[i];return t}function RR(e,t){let r=new Set;return new Set(t),e.reduce((i,s)=>{let c=JSON.stringify(kR(s));return r.has(c)||(r.add(c),i.push({key:c,link:s})),i},[])}function Z2(){let e=U.useContext(Vi);return zg(e,"You must render this element inside a <DataRouterContext.Provider> element"),e}function AR(){let e=U.useContext($l);return zg(e,"You must render this element inside a <DataRouterStateContext.Provider> element"),e}var Dg=U.createContext(void 0);Dg.displayName="FrameworkContext";function e_(){let e=U.useContext(Dg);return zg(e,"You must render this element inside a <HydratedRouter> element"),e}function OR(e,t){let r=U.useContext(Dg),[i,s]=U.useState(!1),[c,u]=U.useState(!1),{onFocus:f,onBlur:h,onMouseEnter:p,onMouseLeave:y,onTouchStart:v}=t,w=U.useRef(null);U.useEffect(()=>{if(e==="render"&&u(!0),e==="viewport"){let N=E=>{E.forEach(R=>{u(R.isIntersecting)})},k=new IntersectionObserver(N,{threshold:.5});return w.current&&k.observe(w.current),()=>{k.disconnect()}}},[e]),U.useEffect(()=>{if(i){let N=setTimeout(()=>{u(!0)},100);return()=>{clearTimeout(N)}}},[i]);let _=()=>{s(!0)},x=()=>{s(!1),u(!1)};return r?e!=="intent"?[c,w,{}]:[c,w,{onFocus:nl(f,_),onBlur:nl(h,x),onMouseEnter:nl(p,_),onMouseLeave:nl(y,x),onTouchStart:nl(v,_)}]:[!1,w,{}]}function nl(e,t){return r=>{e&&e(r),r.defaultPrevented||t(r)}}function MR({page:e,...t}){let{router:r}=Z2(),i=U.useMemo(()=>Va(r.routes,e,r.basename),[r.routes,e,r.basename]);return i?U.createElement(DR,{page:e,matches:i,...t}):null}function zR(e){let{manifest:t,routeModules:r}=e_(),[i,s]=U.useState([]);return U.useEffect(()=>{let c=!1;return TR(e,t,r).then(u=>{c||s(u)}),()=>{c=!0}},[e,t,r]),i}function DR({page:e,matches:t,...r}){let i=Pi(),{manifest:s,routeModules:c}=e_(),{basename:u}=Z2(),{loaderData:f,matches:h}=AR(),p=U.useMemo(()=>bx(e,t,h,s,i,"data"),[e,t,h,s,i]),y=U.useMemo(()=>bx(e,t,h,s,i,"assets"),[e,t,h,s,i]),v=U.useMemo(()=>{if(e===i.pathname+i.search+i.hash)return[];let x=new Set,N=!1;if(t.forEach(E=>{let R=s.routes[E.route.id];!R||!R.hasLoader||(!p.some(O=>O.route.id===E.route.id)&&E.route.id in f&&c[E.route.id]?.shouldRevalidate||R.hasClientLoader?N=!0:x.add(E.route.id))}),x.size===0)return[];let k=_R(e,u,"data");return N&&x.size>0&&k.searchParams.set("_routes",t.filter(E=>x.has(E.route.id)).map(E=>E.route.id).join(",")),[k.pathname+k.search]},[u,f,i,s,p,t,e,c]),w=U.useMemo(()=>CR(y,s),[y,s]),_=zR(y);return U.createElement(U.Fragment,null,v.map(x=>U.createElement("link",{key:x,rel:"prefetch",as:"fetch",href:x,...r})),w.map(x=>U.createElement("link",{key:x,rel:"modulepreload",href:x,...r})),_.map(({key:x,link:N})=>U.createElement("link",{key:x,nonce:r.nonce,...N})))}function jR(...e){return t=>{e.forEach(r=>{typeof r=="function"?r(t):r!=null&&(r.current=t)})}}var t_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{t_&&(window.__reactRouterVersion="7.9.3")}catch{}function LR(e,t){return xk({basename:t?.basename,getContext:t?.getContext,future:t?.future,history:F5({window:t?.window}),hydrationData:UR(),routes:e,mapRouteProperties:oR,hydrationRouteProperties:sR,dataStrategy:t?.dataStrategy,patchRoutesOnNavigation:t?.patchRoutesOnNavigation,window:t?.window}).initialize()}function UR(){let e=window?.__staticRouterHydrationData;return e&&e.errors&&(e={...e,errors:HR(e.errors)}),e}function HR(e){if(!e)return null;let t=Object.entries(e),r={};for(let[i,s]of t)if(s&&s.__type==="RouteErrorResponse")r[i]=new yd(s.status,s.statusText,s.data,s.internal===!0);else if(s&&s.__type==="Error"){if(s.__subType){let c=window[s.__subType];if(typeof c=="function")try{let u=new c(s.message);u.stack="",r[i]=u}catch{}}if(r[i]==null){let c=new Error(s.message);c.stack="",r[i]=c}}else r[i]=s;return r}var n_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,vn=U.forwardRef(function({onClick:t,discover:r="render",prefetch:i="none",relative:s,reloadDocument:c,replace:u,state:f,target:h,to:p,preventScrollReset:y,viewTransition:v,...w},_){let{basename:x}=U.useContext(Hr),N=typeof p=="string"&&n_.test(p),k,E=!1;if(typeof p=="string"&&N&&(k=p,t_))try{let oe=new URL(window.location.href),fe=p.startsWith("//")?new URL(oe.protocol+p):new URL(p),he=ar(fe.pathname,x);fe.origin===oe.origin&&he!=null?p=he+fe.search+fe.hash:E=!0}catch{qt(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let R=Pk(p,{relative:s}),[O,B,F]=OR(i,w),M=qR(p,{replace:u,state:f,target:h,preventScrollReset:y,relative:s,viewTransition:v});function G(oe){t&&t(oe),oe.defaultPrevented||M(oe)}let ie=U.createElement("a",{...w,...F,href:k||R,onClick:E||c?t:G,ref:jR(_,B),target:h,"data-discover":!N&&r==="render"?"true":void 0});return O&&!N?U.createElement(U.Fragment,null,ie,U.createElement(MR,{page:R})):ie});vn.displayName="Link";var BR=U.forwardRef(function({"aria-current":t="page",caseSensitive:r=!1,className:i="",end:s=!1,style:c,to:u,viewTransition:f,children:h,...p},y){let v=Yl(u,{relative:p.relative}),w=Pi(),_=U.useContext($l),{navigator:x,basename:N}=U.useContext(Hr),k=_!=null&&XR(v)&&f===!0,E=x.encodeLocation?x.encodeLocation(v).pathname:v.pathname,R=w.pathname,O=_&&_.navigation&&_.navigation.location?_.navigation.location.pathname:null;r||(R=R.toLowerCase(),O=O?O.toLowerCase():null,E=E.toLowerCase()),O&&N&&(O=ar(O,N)||O);const B=E!=="/"&&E.endsWith("/")?E.length-1:E.length;let F=R===E||!s&&R.startsWith(E)&&R.charAt(B)==="/",M=O!=null&&(O===E||!s&&O.startsWith(E)&&O.charAt(E.length)==="/"),G={isActive:F,isPending:M,isTransitioning:k},ie=F?t:void 0,oe;typeof i=="function"?oe=i(G):oe=[i,F?"active":null,M?"pending":null,k?"transitioning":null].filter(Boolean).join(" ");let fe=typeof c=="function"?c(G):c;return U.createElement(vn,{...p,"aria-current":ie,className:oe,ref:y,style:fe,to:u,viewTransition:f},typeof h=="function"?h(G):h)});BR.displayName="NavLink";var FR=U.forwardRef(({discover:e="render",fetcherKey:t,navigate:r,reloadDocument:i,replace:s,state:c,method:u=Uu,action:f,onSubmit:h,relative:p,preventScrollReset:y,viewTransition:v,...w},_)=>{let x=PR(),N=IR(f,{relative:p}),k=u.toLowerCase()==="get"?"get":"post",E=typeof f=="string"&&n_.test(f),R=O=>{if(h&&h(O),O.defaultPrevented)return;O.preventDefault();let B=O.nativeEvent.submitter,F=B?.getAttribute("formmethod")||u;x(B||O.currentTarget,{fetcherKey:t,method:F,navigate:r,replace:s,state:c,relative:p,preventScrollReset:y,viewTransition:v})};return U.createElement("form",{ref:_,method:k,action:N,onSubmit:i?h:R,...w,"data-discover":!E&&e==="render"?"true":void 0})});FR.displayName="Form";function $R(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function r_(e){let t=U.useContext(Vi);return Ie(t,$R(e)),t}function qR(e,{target:t,replace:r,state:i,preventScrollReset:s,relative:c,viewTransition:u}={}){let f=xr(),h=Pi(),p=Yl(e,{relative:c});return U.useCallback(y=>{if(yR(y,t)){y.preventDefault();let v=r!==void 0?r:Qa(h)===Qa(p);f(e,{replace:v,state:i,preventScrollReset:s,relative:c,viewTransition:u})}},[h,f,p,r,i,t,e,s,c,u])}var YR=0,VR=()=>`__${String(++YR)}__`;function PR(){let{router:e}=r_("useSubmit"),{basename:t}=U.useContext(Hr),r=rR();return U.useCallback(async(i,s={})=>{let{action:c,method:u,encType:f,formData:h,body:p}=xR(i,t);if(s.navigate===!1){let y=s.fetcherKey||VR();await e.fetch(y,r,s.action||c,{preventScrollReset:s.preventScrollReset,formData:h,body:p,formMethod:s.method||u,formEncType:s.encType||f,flushSync:s.flushSync})}else await e.navigate(s.action||c,{preventScrollReset:s.preventScrollReset,formData:h,body:p,formMethod:s.method||u,formEncType:s.encType||f,replace:s.replace,state:s.state,fromRouteId:r,flushSync:s.flushSync,viewTransition:s.viewTransition})},[e,t,r])}function IR(e,{relative:t}={}){let{basename:r}=U.useContext(Hr),i=U.useContext(wr);Ie(i,"useFormAction must be used inside a RouteContext");let[s]=i.matches.slice(-1),c={...Yl(e||".",{relative:t})},u=Pi();if(e==null){c.search=u.search;let f=new URLSearchParams(c.search),h=f.getAll("index");if(h.some(y=>y==="")){f.delete("index"),h.filter(v=>v).forEach(v=>f.append("index",v));let y=f.toString();c.search=y?`?${y}`:""}}return(!e||e===".")&&s.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),r!=="/"&&(c.pathname=c.pathname==="/"?r:jr([r,c.pathname])),Qa(c)}function XR(e,{relative:t}={}){let r=U.useContext(kg);Ie(r!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:i}=r_("useViewTransitionState"),s=Yl(e,{relative:t});if(!r.isTransitioning)return!1;let c=ar(r.currentLocation.pathname,i)||r.currentLocation.pathname,u=ar(r.nextLocation.pathname,i)||r.nextLocation.pathname;return vd(s.pathname,u)!=null||vd(s.pathname,c)!=null}var GR=M2();function WR(e){return U.createElement(cR,{flushSync:GR.flushSync,...e})}var qp={exports:{}},Yp={};/**
 * @license React
